...
<html lang="en">
  ...
  <body>
    ...
    <?php
      $consulta = "SELECT costo,referencia,fecha_de_compra FROM movimiento WHERE DATE_FORMAT(fecha_de_compra,'%m/%Y')='$periodo' and ID_Cuenta='$cuenta'";
      $result = mysqli_query($conexion, $consulta);
    ?>
    <table class="table">
      <thead>
        <tr>
          <th scope="col">Rerferencia</th>
      ...
      <?php while($row=mysqli_fetch_assoc($result)): ?>
        <tr>
          ...
          <td><?php echo $row['fecha_de_compra']?></td>
        </tr>
      <?php endwhile; ?>
    </table>

    <?php
      $consulta = "SELECT sum(costo) as total FROM movimiento WHERE DATE_FORMAT(fecha_de_compra,'%m/%Y')='$periodo' and ID_Cuenta='$cuenta'";
      $result = mysqli_query($conexion, $consulta);
